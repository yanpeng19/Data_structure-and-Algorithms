...
public:
	...
	void erase(Node<T>*);
	//void insert_before(const int&,Node<T>);
	void insert_before(Node<T>* post, Node<T>* e);

	void insert_after(Node<T>* e, Node<T>* post);
	void insert_after(const T& t, Node<T>* post);
	void insert_fir(Node<T>*e) { insert_after(e, head); };
	void insert_fir(const T&t) { insert_after(t, head); };
	void insert_end(Node<T>*e) { insert_before(e, tail.pre); };
	void insert_end(const T& e) { insert_before(e, tail.pre); };
...
template<typename T>
Node<T>* my_list<T>::remove(iterator & t)
{
...
template<typename T>
void my_list<T>::insert_after(Node<T> *t, Node<T>* p)
{
	auto temp = --(begin());
...
template<typename T>
void my_list<T>::insert_after(const T& e, Node<T>* p)
{
